...
const Card = ({ item, onAddToCart, onRemoveFromCart }: CardProps) => {
  return (
    <div className="bg-card p-3 sm:p-4 rounded-lg shadow-md border border-border flex flex-col">
      <div className="h-24 sm:h-32 bg-muted flex items-center justify-center mb-2 sm:mb-3 rounded-full border-2 border-dashed border-border">
      ...
      <h3 className="text-xs sm:text-sm text-foreground mb-2 flex-grow text-center">
        {item.name}
      </h3>
      <p className="font-bold text-sm sm:text-lg text-foreground mb-2 sm:mb-3 text-center">
        R$ {item.price.toFixed(2).replace(".", ",")}
      </p>
      <button
        onClick={() =>
          item.inCart ? onRemoveFromCart(item.id) : onAddToCart(item.id)
        }
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        <div className="bg-muted text-muted-foreground rounded-lg p-3 sm:p-4 relative">
          {/* Desktop Filters */}
          <div className="hidden sm:flex items-center gap-4">
            ...
            <div className="flex-1 max-w-md relative ml-4 sm:ml-8">
              <input
                ...
                className="w-full bg-muted text-muted-foreground placeholder-gray-300 px-4 py-2 rounded-full text-sm focus:outline-none focus:bg-accent"
              />
            ...
            <div className="relative">
              <button
                ...
                className="bg-muted p-2 rounded hover:bg-accent transition-colors relative"
              >
